...
/**
 * Functional tests for the `JPackage` task.
 *
 * @author  Leon Linhart
 */
class JPackageTest : AbstractFunctionalPluginTest() {
    ...
    fun testJPackage(gradleVersion: CharSequence) {
        ...
        val result = GradleRunner.create()
            ...
            .withArguments("jpackage", "--info")
            .forwardOutput()
            .build()

        assertEquals(TaskOutcome.SUCCESS, result.task(":jpackage")?.outcome)
    }
