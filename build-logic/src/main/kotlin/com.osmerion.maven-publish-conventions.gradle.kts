    ...
    publications.withType<MavenPublication>().configureEach {
        pom {
            ...
            licenses {
                license {
                    name = "Apache-2.0"
                    url = "https://github.com/Osmerion/gradle-jdk-tools/blob/master/LICENSE"
                    distribution = "repo"
                }
            }
            ...
            scm {
                connection = "scm:git:git://github.com/Osmerion/gradle-jdk-tools.git"
                developerConnection = "scm:git:git://github.com/Osmerion/gradle-jdk-tools.git"
                url = "https://github.com/Osmerion/gradle-jdk-tools.git"
            }
        }
    }
}
